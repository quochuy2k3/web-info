        ...
        <ScrollReveal>
          <div className="text-center mb-10 sm:mb-16">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 px-8 py-3.5 bg-gradient-to-r from-blue-600 to-orange-600 text-white font-semibold rounded-xl hover:from-blue-500 hover:to-orange-500 transition-all shadow-lg shadow-blue-500/25"
            >
              <Phone size={18} />
              Liên hệ ngay
            </motion.a>
